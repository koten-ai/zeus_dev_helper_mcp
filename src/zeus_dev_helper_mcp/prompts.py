...
- **demo_beer_sample = data-plane Direct example** (zero-LLM catalog UI: find→get BFF; no pipeline; no LLM key). Never the default for every “make a website from this endpoint” utterance when beer-sample / no LLM is named.
